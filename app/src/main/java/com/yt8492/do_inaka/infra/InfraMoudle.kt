...
import com.yt8492.do_inaka.infra.domain.impl.repository.AuthTokenRepositoryImpl
...
class InfraMoudle {
    ...
    @Singleton
    @Provides
    fun provideAuthTokenRepository(impl: AuthTokenRepositoryImpl): AuthTokenRepository = impl
